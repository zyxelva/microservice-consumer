...
@ApiModel(description = "日志上传记录 model")
public class ClientReportRes extends BaseRes {

	private static final long serialVersionUID = -901641103312746213L;
	...
	@ApiModelProperty("OS类型uploadOSType：0-Android、1-iOS、2-WinPhone、3-其它，字典:uploadOSType")
